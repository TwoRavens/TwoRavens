...
def test_dataset_doc_maker(input_file, output_dir):
...
def test_new_dataset_load(user_id, input_file, output_dir):
    """Try it out"""

    udu = UserDatasetUtil(1, input_file, output_dir)
    if udu.has_error():
...
if __name__ == '__main__':
    ...
    #test_dataset_doc_maker(test_file, test_output_dir)

    test_output_dir2 = '/ravens_volume/test_data/00_testit'

    test_new_dataset_load(1, test_file, test_output_dir2)
