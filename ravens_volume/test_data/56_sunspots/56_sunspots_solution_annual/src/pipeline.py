...
prpath = os.path.join(here, '..', '..', '56_sunspots_problem_annual')
...
model = pf.ARIMA(data=train_data, ar=4, ma=4, target=[col['colName'] for col in d3mds.problem.get_targets()][0], family=pf.Normal())
x = model.fit("MLE")
