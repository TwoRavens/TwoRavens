...
plotdata.app <- function(env) {
  ...
  if(plottype=="scatter" | plottype=="aggbar" | plottype=="binnedscatter" | plottype=="histogram" | plottype=="scattermeansd" | plottype=="scattermatrix" | plottype=="simplebar" | plottype=="areauni") {
        tryCatch({
        plotdata <<- list()
