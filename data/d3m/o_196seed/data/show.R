...
trainData$class <- trainTargets$class
testData$class <- NA
trainData$train <- 1
testData$train <- 0
...
#source("/Users/tercer/scratch/products/sola/Vito/TwoRavens/rook/preprocess/preprocess.R")


json5<-preprocess(testdata=allData)
write(json5,file="o_196_Data2R.json")
write.csv(allData, file="o_196_Data2R.csv", row.names=FALSE)
