...
python manage.py test tworaven_apps.ta2_interfaces.testing.test_start_end_session
python manage.py test tworaven_apps.ta2_interfaces.testing.test_create_pipeline
python manage.py test tworaven_apps.ta2_interfaces.testing.test_get_create_pipeline_results
