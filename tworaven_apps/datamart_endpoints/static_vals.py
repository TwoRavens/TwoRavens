...
DATAMART_SEARCH_BY_DATASET = 'DATAMART_SEARCH_BY_DATASET'

KEY_ISI_DATAMART_ID = 'id'
KEY_NYU_DATAMART_ID = 'id'
KEY_DATA = 'data'

# Env variables for loading ISI and NYU url
#
DATAMART_ENV_NYU_URL = 'DATAMART_URL_NYU'   # 'DATAMART_NYU_URL'
DATAMART_ENV_ISI_URL = 'DATAMART_URL_ISI'   # 'DATAMART_ISI_URL'
