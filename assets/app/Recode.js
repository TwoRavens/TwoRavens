            ...
            m('div.outter', {style: {'padding': '10px'}}, [
                ...
                m(`#rightpanel.container.sidepanel.clearfix`, mergeAttributes({
                            ...
                            m('form', {onsubmit: calculateBin}, [
                                m('div', {id: 'binInfo', style: {'margin-bottom': '1%'}}, [
                                    m('span', {
                                        ...
                                        style: {'width': '100%', 'box-sizing': 'border-box', 'white-space': 'nowrap;'}
                                    }),]),
                                    m("br"),
                                    m('textarea', {
                                        id: 'binDescription',
                    ...
                    m('div.container-fluid', {id: 'formulaDiv'}, [
                        ...
                        m('div.container-fluid', {
                            id: 'div1',
                            style: {'display': 'block', 'height': '220px', 'padding': '20px'}
                        }, [
                            ...
                            m('div.container-fluid', {
                                ...
                                m('div', {class: 'collapse', id: "content", style: 'margin:10px;'}, [
                                    ...
                                    m('div.dropdown', {style: {'display': 'inline-block', 'margin': '10px'}}, [
                                        m('select.form-control#typeSelect', {
                                ...
                                m('div', {style: " width: 100%;height: 400px;border: 1px solid black;margin: 10px auto;background-color: white;position: relative;padding-top: 30px;"}, [
                                    ...
                                    m('div#tableDiv', {style: "overflow-x: hidden;overflow-y: auto;height: 100%; text-align:center;"}, [
                                        ...
                                        m('table.table.table-fixed', {
                                            ...
                                            m('thead', [
                                                m('tr#colheader', [
                                                    (tableHeader.slice(1)).filter((header) => filterVars.includes(header)).map((header) => m('th.col-xs-4', {
                                                        style: {
                                            ...
                                            m('tbody', [
                                                tableData.map((row, i) => m('tr#colValues', [
                                                        row.filter((item, j) => filterIndex.indexOf(j) >= 0).map((item, j) => m('td', {
                                                            style: {
                                                                'border': '1px solid #ddd',
                                                                'text-align': 'center'
                                                            }
...
function density_cross(density_env, a, method_name) {
    ...
    if (isNaN(a) || a === 0) {
        ...
        if (method_name === "equidistance") {
            ...
            var intervals = document.getElementById('bin').value.split(',').map(function (x) {
                return parseInt(x)
            }).sort();
            var upper_limit = d3.max(xVals);
            var lower_limit = d3.min(xVals);
