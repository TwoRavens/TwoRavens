        ...
        m(Panel,
                  ...
                  m("tr",
                    ...
                    m("th",
                      m("figure", {style: {"float": "left"}},
                        ...
                        m("figcaption", {style: {"text-align": "center"}},
                          "Linechart"))))))),
            m("[id='result_left1']", {style: {"width": "100%", "height": "60%", "text-align": "center", "margin-top": "3%", "background-color": "white", "overflow": "hidden", "white-space": "nowrap"}},
          ...
          m('#result_right',
            ...
            m('#resultsView_tabular.container1',
              ...
              m('#tabular_1', {style: {width: "100%", height: "30%", "border-bottom-style": "inset", "margin-top": "3%"}},
                m("button.btn.btn-default.btn-sm[id='SelectionData1'][type='button']", {style: {display: "block", margin: "0 auto", position: "relative"}},
                  "Create"),
                m('#plotA', {style: {width: exp.get_width('plotA') + '%', height: "100%", float: "left", overflow: "hidden"}},
                  "plotA"),
                m('#plotB', {style: {width: exp.get_width('plotB') + '%', height: "100%", float: "right", overflow: "hidden"}},
                  "plotB")),
