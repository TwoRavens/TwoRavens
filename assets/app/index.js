            ...
            {value: 'Variables',
             ...
             contents: [
                 ...
                 m(PanelList, {
                    ...
                    m(Button,{id: 'recode', class:'btn btn-block',onclick:_=>window.open("#!/recode", "recode","toolbar=yes,scrollbars=yes,resizable=yes,top=200,left=500,width=1000,height=600") ,title: 'Customize variables.',style: ' width: 100%; display: block; text-align: center; margin-top:75%;'},'Create New Variable')]},
            {value: 'Discovery',
             contents: [
                 m(Table, {
                     id: 'discoveryTable',
