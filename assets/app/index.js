 ...
 /*     m(".btn-group.btn-group-justified#modelGroup[style=margin-top: .5em]",
      ...
      m(`#setx[style=display: ${or('right', 'btnSetx')}]`,
        m('#setxLeftAll[style=display:block; float: left; width: 30%; height:100%; background-color: white]',
          m('#setxLeft[style=display:block; float: left; width: 100%; height:75%; overflow:auto; background-color: white]'),
        m('#setxLeftBottom[style=display:block; float: left; width: 100%; height:25%; clear:left; background-color: white]')),
        m('#setxRightAll[style=display:block; float: left; width: 70%; height:100%; background-color: white]',
          m('#setxRightTop[style=display:block; float: left; width: 100%; height:75%; overflow:auto; background-color: white]',
            ...
            style: `display:inline; float: right; margin-right: 10px`,
