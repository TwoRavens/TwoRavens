    ...
    return mode ?
        m(Panel,
          ...
          m('#result_right[style=width: 50%; height: 90%; float: right; background-color: white; display:none; border-right: groove; border-bottom: groove; overflow: auto; white-space: nowrap]',
            m('.btn-group.btn-group-sm[style=width:auto; height:10%; display:block; white-space:nowrap; margin-left:170px; position:relative]',
              m('button#selection.btn.btn-primary', 'Selection'),
              m('button#crossTabs.btn.btn-primary', 'Cross-Tabs')),
            m('#resultsView_tabular.container1',
              {style: 'width: 100%; height: 60%; background-color: white; display: block; float: left; overflow: auto; white-space: nowrap; border-right: groove; border-bottom: groove'},
              m('.tabular_1[style=width: 100%; height: 100%; display: none]',
                m(`#plotA[style=width: ${exp.get_width('plotA')}%; height: 60%; float: left; display: none; overflow: auto]`, 'plotA'),
                m(`#plotB[style=width: ${exp.get_width('plotB')}%; height: 60%; float: right; display: none; overflow: auto]`, 'plotB'),
                m('#SelectionData[style=width: 100%; height: 40%; display: none; overflow: auto]')),
              m('.tabular_2[style=width: 100%; height: 100%; display: none; background: #ac2925]')),
