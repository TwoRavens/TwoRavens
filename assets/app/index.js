                  ...
                  m("tr",
                    m("th",
                      m("figure", {style: {"float": "left"}},
                        m("img[alt='scatter_plot'][id='scatterplot_img'][src='/static/images/thumb1.png']", {style: {"width": "75%", "height": "75%", "border": "1px solid #ddd", "border-radius": "3px", "padding": "5px", "margin": "3%", "cursor": "pointer"}}),
                        m("figcaption", {style: {"text-align": "center"}},
                          "Scatter Plot"))),
                    m("th",
                      m("figure", {style: {"float": "left"}},
                        m("img[alt='heatmap'][id='heatmap_img'][src='/static/images/thumb2.png']", {style: {"width": "75%", "height": "75%", "border": "1px solid #ddd", "border-radius": "3px", "padding": "5px", "margin": "3%", "cursor": "pointer"}}),
                        m("figcaption", {style: {"text-align": "center"}},
                          "Heatmap"))),
                    m("th",
                      m("figure", {style: {"float": "left"}},
                        m("img[alt='linechart'][id='linechart_img'][src='/static/images/thumb3.png']", {style: {"width": "75%", "height": "75%", "border": "1px solid #ddd", "border-radius": "3px", "padding": "5px", "margin": "3%", "cursor": "pointer"}}),
                        m("figcaption", {style: {"text-align": "center"}},
                          "Linechart"))))))),
