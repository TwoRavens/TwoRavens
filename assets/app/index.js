...
function rightpanel(mode) {
    return mode ?
        m(Panel,
          ...
          m('#result_left', {style: {width: "50%", height: "90%", float: "left", "background-color": "white", "border-right": "groove", overflow: "auto", "white-space": "nowrap"}},
            m('#result_left1', {style: {width: "100%", height: "80%", float: "left", "background-color": "white", "border-right": "groove", "border-bottom": "groove", overflow: "auto", "white-space": "nowrap"}},
              m('#scatterplot.container3', {style: {width: "500px", height: "60%", "background-color": "white", overflow: "auto", "margin-bottom": "10px"}}),
              m('#heatchart.container4', {style: {width: "500px", height: "60%", overflow: "auto", "background-color": "#FFEBEE", "margin-bottom": "20px"}}),
              m("h5#NAcount", {style: {"margin-left": "20px"}})),
            m("#resultsView_statistics.container2",
              {style: {width: "100%", height: "20%", "background-color": "white", float: "left", overflow: "auto", "white-space": 'nowrap', "border-right": 'groove', "border-bottom": "groove"}})),
          m('#result_right',
            ...
            m('#resultsView_tabular.container1',
              ...
              m('#SelectionData', {style: {width: "100%", height: "55%", overflow: "auto", "margin-top": "10px", "border-bottom-style": "inset"}},
                ...
                m("button.btn.btn-default.btn-sm[id='SelectionData1'][type='button']", {style: {display: "block", margin: "0 auto", position: "relative"}},
                  "Create"),
                m('h5[style=color: #ac2925; margin: 5]', 'Selection History'),
                m('p[style=color: #269abc; margin: 5%; font-family: Helvetica Neue, Helvetica, Arial, sans-serif]', 'Previous selection data is stored in the breaks. Select any break to view data.'),
                m('span#breakspace[style=display: block; overflow: auto]')),
              m('#tabular_1', {style: {width: "100%", height: "30%", "border-bottom-style": "inset", "margin-top": "3%", overflow: "auto"}},
                ...
                m('#plotB', {style: {width: exp.get_width('plotB') + '%', height: "100%", float: "right", overflow: "auto"}},
                  "plotB")),
              m('#tabular_2', {style: {width: "100%", height: "40%", "border-bottom-style": "inset", overflow: "auto"}}))),
