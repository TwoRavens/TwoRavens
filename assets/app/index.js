        ...
        m(Panel,
          ...
          m('#result_left', {style: {width: "50%", height: "90%", float: "left", "background-color": "white", display: "none", "border-right": "groove", overflow: "auto", "white-space": "nowrap"}},
            m('#result_left1', {style: {width: "100%", height: "80%", float: "left", "background-color": "white", display: "none", "border-right": "groove", "border-bottom": "groove", overflow: "auto", "white-space": "nowrap"}},
              m('#scatterplot.container3', {style: {width: "500px", height: "60%", "background-color": "white", display: "none", overflow: "auto", "margin-bottom": "10px"}}),
              m('#heatchart.container4', {style: {width: "500px", height: "60%", display: "none", overflow: "auto", "background-color": "#FFEBEE", "margin-bottom": "20px"}}),
