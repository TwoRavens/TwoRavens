...
function rightpanel(mode) {
    return mode ?
        m(Panel,
          ...
          m("[id='result_left']", {style: {"width": "50%", "height": "90%", "float": "left", "background-color": "white", "border-right": "ridge", "border-bottom": "ridge", "overflow": "auto", "white-space": "nowrap"}},
            m("[id='left_thumbnail']", {style: {"width": "100%", "height": "20%", "background-color": "white", "margin-top": "3%", "margin-right": "3%", "border-bottom": "ridge", "overflow": "auto", "white-space": "nowrap"}},
              m("table",
                m("tbody",
                  m("tr",
                    m("th",
                      m("figure", {style: {"float": "left"}},
                        m("img[alt='scatter_plot'][id='scatterplot_img'][src='data/thumb1.png']", {style: {"width": "75%", "height": "75%", "border": "1px solid #ddd", "border-radius": "3px", "padding": "5px", "margin": "3%", "cursor": "pointer"}}),
                        m("figcaption", {style: {"text-align": "center"}},
                          "Scatter Plot"))),
                    m("th",
                      m("figure", {style: {"float": "left"}},
                        m("img[alt='heatmap'][id='heatmap_img'][src='data/thumb2.png']", {style: {"width": "75%", "height": "75%", "border": "1px solid #ddd", "border-radius": "3px", "padding": "5px", "margin": "3%", "cursor": "pointer"}}),
                        m("figcaption", {style: {"text-align": "center"}},
                          "Heatmap"))),
                    m("th",
                      m("figure", {style: {"float": "left"}},
                        m("img[alt='linechart'][id='linechart_img'][src='data/thumb3.png']", {style: {"width": "75%", "height": "75%", "border": "1px solid #ddd", "border-radius": "3px", "padding": "5px", "margin": "3%", "cursor": "pointer"}}),
                        m("figcaption", {style: {"text-align": "center"}},
                          "Linechart"))))))),
            m("[id='result_left1']", {style: {"width": "100%", "height": "60%", "text-align": "center", "margin-top": "3%", "background-color": "white", "overflow": "auto", "white-space": "nowrap"}},
              m(".container3[id='scatterplot']", {style: {"width": "500px", "height": "80%", "background-color": "white", "float": "left", "overflow": "auto", "margin": "5% "}}),
              m(".container4[id='heatchart']", {style: {"width": "500px", "height": "80%", "float": "left", "overflow": "auto", "background-color": "#FFEBEE", "margin": "5%  "}}),
              m(".container4[id='linechart']", {style: {"width": "500px", "height": "80%", "background-color": "white", "float": "left", "overflow": "auto", "margin": "5% "}})),
            m("div", {style: {"border-bottom": "ridge", "display": "inline-block", "width": "100%", "margin-bottom": "2%", "text-align": "center"}},
              m("h5[id='NAcount']", {style: {" margin-bottom": "0"}})),
            m(".container2[id='resultsView_statistics']", {style: {"width": "100%", "height": "15%", "background-color": "white", "float": "left", "white-space": "nowrap", "margin-bottom": "3%", "border-bottom": "ridge"}})),
          m('#result_right',
            {style: {width: "50%", height: "90%", float: "right", "background-color": "white", "border-right": "groove", "overflow": "auto", "white-space": "nowrap"}},
            m('#resultsView_tabular.container1',
              ...
              m('#SelectionData', {style: {width: "100%", height: "55%", overflow: "auto", "margin-top": "10px", "border-bottom-style": "inset"}},
                m("fieldset", {style: {margin: "3%"}},
                  ...
                  m("p", {style: {"font-family": "Arial, Helvetica, sans-serif", "font-size": "12px"}},
                    "Enter the numbers for both plots respectively to specify the distribution of the cross-tabs"),
                ...
                m('#forPlotB', {style: {display: "block", margin: "2%"}},
                  ...
                  m("button.btn.btn-default.btn-xs#Equidistance2[type='button']", {style: {float: "left", "margin-left": "2%"}},
                    "EQUIDISTANCE"),
                  m("button.btn.btn-default.btn-xs#Equimass2[type='button']", {style: {float: "left", "margin-left": "2%"}},
                    "EQUIMASS")),
                ...
                m('p[style=color: #269abc; margin-top: 1%; margin-left: 2%; font-family: Helvetica Neue, Helvetica, Arial, sans-serif]', 'Previous selection data is stored in the breaks. Select any break to view data.'),
                m('#breakspace[style=display: inline-block; overflow: auto; width: 100%]')),
              m('#tabular_1', {style: {width: "100%", height: "30%", "border-bottom-style": "inset", "margin-top": "3%", overflow: "auto"}},
                m('#plotA', {style: {width: exp.get_width('plotA') + '%', height: "100%", float: "left", overflow: "auto"}},
                  "plotA"),
                m('#plotB', {style: {width: exp.get_width('plotB') + '%', height: "100%", float: "right", overflow: "auto"}},
                  "plotB")),
              m('#tabular_2', {style: {width: "100%", height: "50%", "border-bottom-style": "inset", overflow: "auto"}}))),
