...
class Body {
    ...
    view(vnode) {
        ...
        let exploreVars = () => {
            ...
            return m('div', {style}, [
                thumb(1, 'scatter', "Scatter Plot"), thumb(2, 'tableheat', "Heatmap"), thumb(3, 'line', "Line Chart"), thumb(4, 'stackedbar', "Stacked Bar"),thumb(5, 'box', "Box Plot"), thumb(6, 'groupedbar', "Grouped Bar"),thumb(7, 'strip', "Strip Plot"),thumb(8, 'aggbar', "Aggregate Bar"),thumb(9, 'binnedscatter', "Binned Scatter"), thumb(10, 'step', "Step Chart"),
