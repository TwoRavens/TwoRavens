...
function rightpanel(mode) {
    return mode ?
        m(Panel,
          ...
          m('#result_left', {style: {width: "50%", height: "90%", float: "left", "background-color": "white", display: "none", "border-right": "groove", overflow: "auto", "white-space": "nowrap"}},
            m('#result_left1', {style: {width: "100%", height: "80%", float: "left", "background-color": "white", display: "none", "border-right": "groove", "border-bottom": "groove", overflow: "auto", "white-space": "nowrap"}},
              m(".container3[id='scatterplot']", {style: {"width": "500px", "height": "60%", "background-color": "white", "display": "none", "overflow": "auto", "margin-bottom": "10px "}}),
              m(".container4[id='heatchart']", {style: {"width": "500px", "height": "60%", "display": "none", "overflow": "auto", "background-color": "#FFEBEE", "margin-bottom": "20px "}}),
              m("h5#NAcount", {style: {" margin-left": "20px", "display": "none"}})),
            m("#resultsView_statistics.container2",
              {style: {width: "100%", height: "20%", "background-color": "white", display: "none", float: "left", overflow: "auto", "white-space": 'nowrap', "border-right": 'groove', "border-bottom": "groove"}})),
          m('#result_right',
            {style: {width: "50%", height: "90%", float: "right", "background-color": "white", display: "none", "border-right": "groove", "overflow": "auto", "white-space": "nowrap"}},
            m('#resultsView_tabular.container1',
              ...
              m('#SelectionData', {style: {width: "100%", height: "40%", display: "none", overflow: "auto"}}),
              m('#SelectionData', {style: {width: "100%", height: "50%", display: "none", overflow: "auto", "margin-top": "10px", "border-bottom-style": "inset"}},
                m("fieldset", {style: {"margin": "5%"}},
                  ...
                  m("p[id='boldstuff']", {style: {"color": "#2a6496", "font-family": "Arial, Helvetica, sans-serif", "font-size": "12px"}},
                    "Select between Equidistant and Equimass")),
                m("[id='forPlotA']", {style: {"display": "block", "margin": "2%"}},
                  m("input[id='input1'][name='fname'][type='text']", {style: {"margin-left": "2%"}}),
                  m("button.btn.btn-default.btn-xs[id='Equidistance1'][type='button']", {style: {"float": "left", "margin-left": "2%"}},
                    "EQUIDISTANCE"),
                  m("button.btn.btn-default.btn-xs[id='Equimass1'][type='button']", {style: {"float": "left", "margin-left": "2%"}},
                    "EQUIMASS")),
                m("[id='forPlotB']", {style: {"display": "block", "margin": "2%"}},
                  m("input[id='input2'][name='fname1'][type='text']", {style: {"margin-left": "2%"}}),
                  m("button.btn.btn-default.btn-xs[id='Equidistance2'][type='button']", {style: {"float": "left", "margin-left": "2%"}},
                    "EQUIDISTANCE"),
                  m("button.btn.btn-default.btn-xs[id='Equimass2'][type='button']", {style: {"float": "left", "margin-left": "2%"}},
                    "EQUIMASS")),
                m("button.btn.btn-default.btn-sm[id='SelectionData1'][type='button']", {style: {" display": "block", "margin": "0 auto", "position": "relative"}},
                  "Create")),
              m('#tabular_1', {style: {"width": "100%", "height": "30%", "display": "none", "border-bottom-style": "inset", "margin-top": "3%", "overflow": "auto"}},
                m('#plotA', {style: {"width": exp.get_width('plotA'), "height": "100%", "float": "left", "display": "none", "overflow": "auto"}},
                  "plotA"),
                m('#plotB', {style: {"width": exp.get_width('plotB'), "height": "100%", "float": "right", display: "none", "overflow": "auto"}},
                  "plotB")),
              m('#tabular_2', {style: {"width": "100%", "height": "50%", "display": "none", "border-bottom-style": "inset", "overflow": "auto"}}),
