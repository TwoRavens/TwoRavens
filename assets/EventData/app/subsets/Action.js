...
export function resetActionCounts() {
    pentaCounts = [];
    actionBuffer = [];
...
export function drawGraphs() {
    ...
    actionSubY.domain(actionSubData.map(function (d) {
        return d.rootCode;
    })).padding(0.15);
...
export function updateData() {
    ...
    actionMainGraphData = actionMainGraphData.data(pentaCounts, function (d) {
        return d.count;
    });
    ...
    actionMainGraphData = actionMainGraphData.enter()
        .append("g").attr("id", function (d) {
            return "Data" + d.classNum;
        })
        .each(function (d) {
            d3.select(this).append("rect")
                .attr("id", function (d) {
                    return "actionBar_click" + d.classNum;
                })
                ...
                .attr("x", function (d) {
                    return actionMainX(d.count);
                }).attr("y", function (d) {
                return actionMainY(d.classNum);
            })
                .on("click", function (d) {
                ...
                .on("mouseover", function (d) {
                    ...
                    $("#actionBar" + d.classNum).attr("class", oldClasses + " "
                        + oldClasses.split(/(\s+)/).filter(function (e) {
            ...
            d3.select(this).append("rect")
                .attr("id", function (d) {
                    return "actionBar" + d.classNum;
                }).attr("class", "actionBar actionBar_none")
                .attr("x", 0).attr("height", actionMainY.bandwidth()).attr("y", function (d) {
                return actionMainY(d.classNum);
            })
                .attr("width", function (d) {
                    return actionMainX(d.count);
            ...
            d3.select(this).append("text")
                .attr("class", "actionBar_label").attr("x", function (d) {
                return actionMainX(d.count) + 5;
            })
                .attr("y", function (d) {
                    return actionMainY(d.classNum) + actionMainY.bandwidth() / 2 + 4;
                })
                .text(function (d) {
                    return "" + d.count;
                });
    ...
    actionSubGraphData = actionSubGraphData.data(actionSubData, function (d) {
        return d.rootCode + "_" + d.count;
    });
    actionSubGraphData.exit().remove();

    actionSubGraphData = actionSubGraphData.enter()
        .append("g").attr("id", function (d) {
            return "SubData" + d.rootCode;
        })
        .each(function (d) {
            d3.select(this).append("rect")
                .attr("id", function (d) {
                    return "actionSubBar_click" + d.rootCode;
                })
                ...
                .attr("x", function (d) {
                    return actionSubX(d.count);
                }).attr("y", function (d) {
                return actionSubY(d.rootCode);
            })
                .on("click", function (d) {
                    // console.log("clicked on actionSubBar" + d.rootCode);
                    d.active = !d.active;
                    $("#actionSubBar" + d.rootCode).attr("class", function () {
                        return "actionBar " + (d.active ? "actionBar_all" : "actionBar_none");
                    });
            ...
            d3.select(this).append("rect")
                .attr("id", function (d) {
                    return "actionSubBar" + d.rootCode;
                })
                ...
                .attr("x", 0).attr("height", actionSubY.bandwidth()).attr("y", function (d) {
                return actionSubY(d.rootCode);
            })
                .attr("width", function (d) {
                    return actionSubX(d.count);
            ...
            d3.select(this).append("text")
                .attr("class", "actionBar_label").attr("x", function (d) {
                return actionSubX(d.count) + 5;
            })
                .attr("y", function (d) {
                    return actionSubY(d.rootCode) + actionSubY.bandwidth() / 2 + 4;
                })
                .text(function (d) {
                    return "" + d.count;
                });
