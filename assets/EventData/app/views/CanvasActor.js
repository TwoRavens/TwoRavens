                  ...
                  [
                    m(".panel-heading.text-center[id='actorSelectionTitle']", {style: {"padding-bottom": "5px"}},
                      [
                        ...
                        m("[id='actorAggToggleDiv']", {style: {"display": "none", "position": "relative", "top": "-2px"}}, 
                          m("label.aggChkLbl",
                            [
                    ...
                    m("[id='tabDiv']", {style: {"overflow": "hidden"}}, 
                      m(".btn-group[data-toggle='buttons'][id='actorRadio']", {style: {"margin-left": "6px", "width": "calc(100% - 12px)"}},
                        [
