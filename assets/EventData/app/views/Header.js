    ...
    return(m("nav.navbar.navbar-default.navbar-fixed-top[id='navbar'][role='navigation']",
      [
        m("a.navbar-brand", {style: {"margin-left": "0"}}, 
          m("img[alt='TwoRavens'][onmouseout='closeabout();'][onmouseover='about();'][src='../images/TwoRavens.png'][width='100']", {style: {"margin-left": "2em", "margin-top": "-0.5em"}})
        ),
        m("[id='navbarNav']", {style: {"margin-top": "11px"}},
          [
            ...
            m("label.btn.btn-default.ladda-button.navbar-right[data-spinner-color='#818181'][data-style='zoom-in'][id='btnSubmit'][onclick='submitQuery()']", {style: {"float": "right", "margin-left": "2em", "margin-right": "1em"}}, 
              m("span.ladda-label", "Subset")
            ),

            // Button Reset
            m("button.btn.btn-default.ladda-button.navbar-right[data-spinner-color='#818181'][data-style='zoom-in'][id='btnReset'][onclick='reset()'][title='Reset']", {style: {"margin-left": "2.0em", "float": "right"}}, 
              m("span.ladda-label.glyphicon.glyphicon-repeat", {style: {"font-size": "1em", "color": "#818181", "pointer-events": "none"}})
            ),
              ...
              m(".popover-markup", {style: {"display": "inline"}},
                [
                  m("a.trigger.btn.btn-sm.btn-default[href='#']", {style: {"height": "30px"}}, 
                    m("span.glyphicon.glyphicon-chevron-down", {style: {"margin-top": "3px", "font-size": "1em", "color": "#818181", "pointer-events": "none"}})
                  ),
                  m(".head.hide", 
                    "Dataset"
                  ),
                        ...
                        m(".optionView[id='optionView1']",
                          [
                            m("button.btn.btn-sm.btn-default[data-option='1'][id='option']", 
                              m("span.glyphicon.glyphicon-chevron-left", {style: {"font-size": "1em", "color": "#818181", "pointer-events": "none"}})
                            ),
        ...
        m(".panel.panel-default[id='about']", {style: {"margin-top": "62px", "width": "500px", "display": "None", "z-index": "50"}}, 
          m(".panel-body")
        )
      ]
    ));
