          ...
          [
            m("[id='subsetLeftPanelSelection']",
              [
                ...
                m(".btn-group[data-toggle='buttons'][id='leftpanelButtons']", {style: {"margin-left": "6px", "width": "calc(100% - 12px)"}},
                  [
                ...
                m("[id='leftpanelContent']",
                  [
                    m("[id='variableTab']", {style: {"display": "block", "padding": "10px 8px", "text-align": "center", "width": "100%"}},
                      [
                        m("input.form-control[id='searchvar'][placeholder='Search Variables and Labels'][type='text']", {style: {"width": "100%", "margin-bottom": "5px"}}),
                        m("[id='variableList']", {style: {"display": "inline", "text-align": "center", "position": "absolute", "left": "6px", "top": "128px", "height": "calc(100% - 128px)", "width": "226px", "overflow-y": "scroll"}})
                      ]
                    ),
                    m("[id='subsetTab']", {style: {"display": "none", "padding": "10px 8px", "text-align": "center", "width": "100%", "height": "100%"}}, 
                      m("[id='subsetList']", {style: {"display": "inline", "text-align": "center", "position": "absolute", "left": "6px", "width": "226px"}})
                    )
                  ]
                )
              ]
              ...
              [
                m("[id='aggregUnitSelection']",
                  [
                    ...
                    m("[id='aggregOptions']",
                      [
                        m("p[id='aggregDateToggle']", {style: {"width": "100%", "text-align": "center"}}, "Date"),
                        m("p[id='aggregActorToggle']", {style: {"width": "100%", "text-align": "center"}}, "Actors")
                      ]
                    )
                  ]
                ),
                m("[id='aggregEventSelection']",
                  [
                    ...
                    m("[id='aggregEventOptions']",
                      [
                        m("p[id='aggregPentaToggle']", {style: {"width": "100%", "text-align": "center"}}, "Penta Class"),
                        m("p[id='aggregRootToggle']", {style: {"width": "100%", "text-align": "center"}}, "Rootcode")
                      ]
                    )
                  ]
                )
