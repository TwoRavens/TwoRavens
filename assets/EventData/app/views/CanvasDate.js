...
optionsMenuDate(mode) {
  ...
  if (mode === "subset") {
    return(m("[id='dateOptions']", {style: {"display": "inline-block", "vertical-align": "top", "width": "20%", "margin": "20px"}},  
      
      m(".form-group[id='dateInterval']",
        [ 
          // Set date from slider
          m("button.btn.btn-default[id='setDatefromSlider'][onclick='setDatefromSlider()'][type='button']", {style: {"margin-top": "10px", "text-align": "center"}}, "Bring Date from Slider"),
          
          // From date
          m("label[for='fromdate'][id='dateFromLab']", {style: {"text-align": "left", "width": "100%", "margin-top": "10px"}}, "From:"),
          m("input.form-control[id='fromdate'][type='text']"),
          
          // To date
          m("label[for='todate'][id='dateToLab']", {style: {"text-align": "left", "width": "100%", "margin-top": "10px"}}, "To:"),
